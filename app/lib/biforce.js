function biforce(data,cols){
    ...
    var w = $("#bipolar-viz").width(),
        h = $(window).height()-($("#hashtags-viz").height()+$(".header").height()+$(".cities").height()),
        padding = 2,
        clipPadding = 4,
        fill = d3.scale.category10();

    var radius = d3.scale.sqrt().range([0, 12])
    var vis = d3.select("#bipolar-viz").append("svg:svg")
        .attr("width", w)
        .attr("height", h);
    ...
    j1n.append("clipPath")
        .attr("id", function(d) { return "g-clip-j1-" + d.key; })
        .append("rect");
    ...
    j2n.append("clipPath")
        .attr("id", function(d) { return "g-clip-j2-" + d.key; })
        .append("rect");
    ...
    node.select(".g-j2 circle")
        .attr("clip-path", function(d) { return d.k < 1 ? "url(#g-clip-j1-" + d.key + ")" : null; });

    node.select(".g-j1 circle")
        .attr("clip-path", function(d) { return d.k > 0 ? "url(#g-clip-j2-" + d.key + ")" : null; });
